	...
	<div class="main_content">
		<div class="main_jobs_moduel moduel">
			<form name="job_info">
				...
				<input type="text" name="job_name" placeholder="您要发布的职位名称">
				<br>
				<img src="/dist/loc.png">
				<select class="job_province" name="job_province" onchange="selectcityarea('job_province','job_city','job_info');">
					<option>选择省份</option>
				</select>
				<select class="job_city" name="job_city">
					<option>选择城市</option>
				</select>
				<input class="mid" type="text" name="job_location" placeholder="详细地址">
				<br>
				<img src="/dist/sal.png">
				<input class="moreSmall" type="text" name="job_salary_min" placeholder="最低薪水">
				千元 &nbsp 到
				<input class="moreSmall" type="text" name="job_salary_max" placeholder="最高薪水">
				千元
				<br>
				<img src="/dist/type.png">
				<select class="job_level_1">
					<option selected="selected">职能大类</option>
				</select>
				<select class="job_level_2">
					<option selected="selected">职能分类</option>
				</select>
				<select class="job_level_3">
					<option selected="selected">具体工作</option>
				</select>
				<br>

				<img src="/dist/exp.png">
				<select class="job_experience" name="job_experience">
				...
				<select class="job_education" name="job_education">
				...
				<br>
				<textarea class="job_description" name="job_description" placeholder="对您发布的职位待遇以及详情进行描述"></textarea>
			</form>
		</div>
	</div>
</div>
